...
func Evaluate_idenitifierExpr(expr ast.SymbolExpr, env *typechecker.Environment) typechecker.RuntimeValue {
	return env.GetRuntimeValue(expr.Symbol)
}
...
func Evaluate(astNode ast.Expr, env *typechecker.Environment) typechecker.RuntimeValue {
